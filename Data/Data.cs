...
namespace LI_Angular.Data
{
    ...
    static List<Book> allBooks = new List<Book>()
    {
        ...
        new Book()
        {
            ...
            DateEnd= new DateTime(2019,03,23)
        },
        new Book()
        {
            Id = 4,
        ...
        new Book()
        {
            ...
            DateEnd = new DateTime(2019,06,26),
        },
        new Book()
        {
            Id = 7,
            ...
            DateEnd = new DateTime(2019,07,19),
        },
        new Book()
        {
            Id = 8,
            ...
            DateEnd = new DateTime(2019,08,19),
        },
        new Book()
        {
            Id = 9,
            ...
            DateEnd = new DateTime(2019,09,18),
        },
        new Book()
        {
            Id = 10,
            ...
            DateEnd = new DateTime(2019,10,28)
        }
    };
